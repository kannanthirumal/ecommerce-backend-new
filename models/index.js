...
const CartProduct = db.sequelize.define("cart_products", {
  quantity: {
...
// Add a hook to remove records with quantity 0 before they are saved
// CartProduct.beforeSave((cartProduct, options) => {
